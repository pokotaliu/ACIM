    ...
    <div className="min-h-screen">
      ...
      <header className="min-h-[80vh] flex flex-col items-center justify-center px-6 py-20">
        ...
        >
          ...
          <p className="text-chinese text-lg text-[var(--color-text-muted)] leading-relaxed">
            「每一課都在鬆動你以為知道的」
          </p>
        </div>
        ...
        >
          {isLoaded && hasProgress ? (
            ...
            <div className="text-center">
              ...
              <p className="text-english text-lg md:text-xl mb-6">
      ...
      <footer className="py-16 text-center border-t border-[var(--color-border)]">
        <div className="max-w-2xl mx-auto px-6">
          <p className="text-english text-lg text-[var(--color-text-muted)] italic mb-4">
            "A comfortable sense of leisure is essential."
          </p>
          <p className="text-chinese text-sm text-[var(--color-text-muted)] mb-8">
            從容不迫的感覺是必要的。
          </p>
